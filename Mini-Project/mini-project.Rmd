...
The data you will access can be accessed directly from the Tennessee Department of Education's website (below):
https://www.tn.gov/education/districts/federal-programs-and-oversight/data/data-downloads.html

Specifically, please download the CSV named as *School Level - One file containing all schools (WARNING: Large)*. This file is beneath the "Tennessee Educator Survey" > "2023 Educator Survey Results" > "Teachers" headings.
